...
def main():
    ...
    train_dataset = dataset["train"].filter(lambda x: x['odai_type'] == 'text')
    ...
    bi_encoder_client.train_with_lora(train_dataset, output_dir=output_dir, epochs=5, batch_size=batch_size)
